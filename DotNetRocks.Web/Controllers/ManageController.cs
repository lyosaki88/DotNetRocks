    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.Error ? "系统发生错误。"
                : message == ManageMessageId.AddPhoneSuccess ? "绑定手机成功。"
                : message == ManageMessageId.RemovePhoneSuccess ? "解除手机绑定成功。"
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            ...
            ViewBag.Status = "测试版本可直接绑定手机号码, 您的认证码是" + code ;
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("", "手机号码认证失败");
            return View(model);
        }
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "第三方登陆已删除"
                : message == ManageMessageId.Error ? "系统出现异常"
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
            {
